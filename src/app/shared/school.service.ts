...
export class SchoolService {
  ...
  loadFormData(school: School, address: Address, contacts: Contact[]) {
    ...
    this.formGroup.setValue({
      ...
      city: address.city,
      contacts,
      cooperationContract: school.cooperationcontract || false,
      cooperationPartner: school.cooperationpartner || null,
      kaoaSupervisor: school.kaoaSupervisor || null,
      talentScout: school.talentscout || null,
    })
  }
